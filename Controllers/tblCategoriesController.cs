...
namespace PorjectMVC.Controllers
{
    ...
    public class tblCategoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CategoriesId,CategoriesName")] tblCategory tblCategory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CategoriesId,CategoriesName")] tblCategory tblCategory)
        {
            if (ModelState.IsValid)
            {
